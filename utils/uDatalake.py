...
class BlobConnection:
    ...
    def write_dataframe_to_csv(self, data: DataFrame, container: str, blob_name: str, index: bool=False, header: bool=True) -> None:
        ...
        blob_client.upload_blob(data.to_csv(index=index, header=header), overwrite=True)
